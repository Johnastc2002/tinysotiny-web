...
export default function ProjectPage({
  ...
  // Parallax for Title: as we reach the end of horizontal scroll, title moves up?
  // Or title is part of the white content section that naturally comes after.
  // The user said: "first is when allthe banner showed, the title will keep moving up"
  // This implies the title might be "under" the banner section or parallaxing over it.
          ...
          <div className="flex flex-col md:flex-row gap-0">
            ...
            <div className="w-full md:w-1/2 bg-white pt-8 pb-8 pr-8 md:pt-16 md:pb-16 md:pr-16 pl-12 md:pl-24 shadow-lg pointer-events-auto rounded-r-3xl">
              ...
              >
                ...
                {/* Casts */}
                <div className="text-lg text-gray-600 leading-relaxed whitespace-pre-line font-light mb-12">
                  {project.cast}
                </div>
